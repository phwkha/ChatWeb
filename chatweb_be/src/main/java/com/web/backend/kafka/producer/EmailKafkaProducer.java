...
public class EmailKafkaProducer {
    ...
    @Value("${spring.kafka.email.email-topic}")
    ...
    public void sendOtpEmailTask(String to, String name, String otp) {
        ...
        KafkaEmailEvent event = KafkaEmailEvent.createOtpEvent(to, name, otp);
    ...
    public void sendTextEmailTask(String to, String subject, String content) {
        ...
        KafkaEmailEvent event = KafkaEmailEvent.createTextEvent(to, subject, content);
        kafkaTemplate.send(EMAIL_TOPIC, event);
