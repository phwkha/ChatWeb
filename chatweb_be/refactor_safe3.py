...
def process_file(filepath):
    ...
    target_strings = [
        "user_details", "#username", "friends:", "otp:", 
        "/queue/notifications", "avatars", "chat:recent:", 
        "unread_counts:", "blacklist:", "cooldown:resend:",
        "register:", "role.permissions", "role.name", "accessToken"
    ]
    ...
    # Replace
    for i, line in enumerate(new_lines):
        # don't replace in Slf4j or other places that break easily, wait, target_strings are safe.
